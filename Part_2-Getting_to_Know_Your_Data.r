...
# find out more about the iris data. We can do that by typing '?' before the name, or
# by typing 'help (iris)'.
...
# Notice that the first four variables are of type 'numeric'. The fifth variable,
# 'Species', is of type 'factor'.
