...
# By default, hist() shows the frequency of occurrence of values, as indicated by the y-axis label.
# If you set 'prob=TRUE', hist() will calculate the likelihood of occurrence of the value interval on
# the x-axis, i.e., a probability density. The lines() function adds a density curve to the plot.
